...
#scoreboard players set @e[tag=Respawner] 
#
#execute as @e[tag=Respawner] at @e[tag=Spawned] if score @s SpawnerID = @e[tag=Spawned,limit=1,sort=nearest] SpawnerID store success score @s SpawnFound run scoreboard players set @s SpawnFound 1
